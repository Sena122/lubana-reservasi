...
@section('title', 'Tambah Menu - Lubana Sengkol')
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="section-subtitle">
                Formulir Tambah Data Menu <span>Lubana Sengkol</span>
            </p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-1">
                    ...
                    <div class="form-input-group">
                        <textarea name="description"
                            ...
                            class="resize-none">{{ old('description') }}</textarea>
                    </div>
                    @error('description')
                    <p class="text-[10px] font-bold text-rose-500 mt-1">{{ $message }}</p>
                    @enderror
                ...
                <div class="availability-box">
                    ...
                    <label class="toggle-switch">
                        <input type="checkbox" name="is_available" id="field_is_available" value="1" {{ old('is_available', true) ? 'checked' : '' }}>
